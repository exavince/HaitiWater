...
\newpage
	...
	\chapter{Organisation}
		...
		\section{Méthodologie}
			...
			\paragraph*{Rédaction}
			La rédaction du mémoire n'a commencé que lorsque la plupart des fonctionnalités étaient terminées. Cela a permis de lancer la validation au plus vite afin de pouvoir prendre en compte les différents feedbacks et d'ainsi pour les utiliser.
			Durant la rédaction, les parties produites ont été relue par mes deux promoteurs séparément afin d'améliorer celle-ci mais aussi par des relecteurs externes afin que le texte soit plus agréable à lire. 
	...
	\chapter{Analyse des besoins}
		...
		C'est lors de ce cette phase que nous mes deux promoteurs, l'étudiante d'Haïti et moi-même avons choisi quelle technologie était la plus adaptée afin de faire évoluer l'application existante de la meilleure façon possible. C'est également à ce moment qu'on été déterminé toutes les fonctionnalités à implémenter et leur ordre de priorité.
		Cette phase est la phase la plus importante car c'est ici que l'on 

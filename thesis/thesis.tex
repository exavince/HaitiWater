...
\makenoidxglossaries
	...
	\newacronym{ueh}{UEH}{Université d'Etat d'Haïti}
	...
	\newglossaryentry{module}{name={Module}, description={Une partie de l'application reprennant }}
	...
	\newglossaryentry{postgis}{name={PostGis}, description={Extension de base de données spatiale pour postGreSQL}}
